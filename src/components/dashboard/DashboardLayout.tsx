...
export const DashboardLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0d0e11] flex flex-col text-[#f3f3ee] font-serif" dir="rtl">
      {/* Top Header */}
      <header className="h-16 bg-[#14151a] border-b border-[#262833] px-6 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link to="/" className="text-base font-semibold tracking-tight text-[#cc785c]">
            المساعد الذكي
          </Link>
          ...
          <nav className="flex items-center gap-1">
            ...
            <NavLink
              to="/settings"
              className="px-3 py-1.5 rounded-xl text-xs font-medium text-[#9da0a8] hover:text-[#f3f3ee] hover:bg-[#1a1b22] transition-colors"
            >
              خوادم الربط (MCP)
            </NavLink>
          </nav>
